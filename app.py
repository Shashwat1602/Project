...
app = Flask(__name__)
app.secret_key = 'a'
conn = ibm_db.connect("DATABASE=bludb; HOSTNAME=b70af05b-76e4-4bca-a1f5-23dbb4c6a74e.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud; PORT=32716; UID=rdr86840;PASSWORD=eDsUFALTkHaJU4Wf; SECURITY=SSL;SSLCertificate = DigiCertGlobalRootCA.crt", "", "")
