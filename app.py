...
app = Flask(__name__)
app.secret_key = 'a'
conn = ibm_db.connect("DATABASE=bludb; HOSTNAME=b70af05b-76e4-4bca-a1f5-23dbb4c6a74e.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud; PORT=32716; UID=rdr86840;PASSWORD=eDsUFALTkHaJU4Wf; SECURITY=SSL;SSLServerCertificate = DigiCertGlobalRootCA.crt", "", "")
    ...
    if request.method=="POST":
       for x in range (1,5):
        ...
        if f.filename != '':
            ...
            COS_API_KEY_ID = "MtKaNyZxupXn5l3_LY9UD5s3ZyYEUmfnRrGCMeq3_a1u"
            COS_INSTANCE_CRN = "crn:v1:bluemix:public:cloud-object-storage:global:a/85ea8dbe386a494e823d0e52d7372d04:243f6751-5380-4d61-84ac-d006186d5c66::"
            ...
            cos.meta.client.upload_file(Filename= filepath,Bucket='bucket-shashwat',Key= u+x+".pdf")
...
def marksassign(stdname):
    ...
    output = cos.list_objects(Bucket="bucket-shashwat")
    output
    l=[]
